...
private const val SERVICE_NAME = "export"

class ExportToTextFileService : IntentService(SERVICE_NAME) {
    ...
    companion object {
        ...
        fun start(context: Context, data: ArrayList<String>) {
            context.startService(Intent(context, ExportToTextFileService::class.java).apply {
