...
class MainActivity : AppCompatActivity() {
    ...
    private fun requestCallPermission() {
        ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.CALL_PHONE), RP_CALL)
    }
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>,
        ...
        if (requestCode == RP_CALL && hasPermission(Manifest.permission.CALL_PHONE)) {
            ...
            if (!ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                btnSearch.snackbar(R.string.main_activity_no_call_permission_rationale)
            }
        }
    }

    private fun reportRationale() {
        btnSearch.snackbar(R.string.general_permission_required, getString(R.string.general_configure)) {
