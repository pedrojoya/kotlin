...
class MainFragmentListAdapter : ListAdapter<Student, MainFragmentListAdapter.ViewHolder>(DIFF_CALLBACK) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainFragmentListAdapter.ViewHolder {
        val itemView = parent.inflate(R.layout.fragment_main_item)
        val viewHolder = MainFragmentListAdapter.ViewHolder(itemView)
    ...
    override fun onBindViewHolder(viewHolder: MainFragmentListAdapter.ViewHolder, position: Int) {
